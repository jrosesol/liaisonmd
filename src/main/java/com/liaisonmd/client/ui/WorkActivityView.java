...
import com.liaisonmd.client.i18n.UtilFunc;
import com.liaisonmd.client.ui.Portlet.PortletUiBinder;
...
public class WorkActivityView extends Composite implements Editor<TimeEntryProxy> {
    ...
    public WorkActivityView(final Provider<AppsConstants> appCteProvider,
        ...
        //driver.edit(this.timeEntry, factory.timeEntryRequest().saveTimeEntry(this.timeEntry, null, null).to(receiver));
